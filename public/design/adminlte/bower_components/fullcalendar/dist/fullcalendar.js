...
var View = /** @class */ (function (_super) {
        ...
        if (this.opt('nowIndicator')) {
            ...
            if (unit) {
                ...
                this.nowIndicatorTimeoutID = setTimeout(function () {
                    ...
                    _this.nowIndicatorIntervalID = setInterval(update, delay); // updateStore every interval
                }, delay);
            }
    ...
    View.prototype.reportEventDrop = function (eventInstance, eventMutation, el, ev) {
        ...
        // updateStore the EventInstance, for handlers
        if (dateMutation) {
...
var Toolbar = /** @class */ (function () {
    ...
    // method to updateStore toolbar-specific options, not calendar-wide options
